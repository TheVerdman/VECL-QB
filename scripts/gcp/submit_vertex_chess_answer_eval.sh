...
PKG_DIR="/tmp/vecl-qb-chess-answer-eval-${JOB_TS}"
PACKAGE_TGZ="/tmp/vecl-qb-chess-answer-eval-${JOB_TS}.tar.gz"
CONFIG_YAML="/tmp/vecl-qb-chess-answer-eval-${JOB_TS}.yaml"
