...
PKG_DIR="/tmp/vecl-qb-terraform-stockfish-eval-${JOB_TS}"
PACKAGE_TGZ="/tmp/vecl-qb-terraform-stockfish-eval-${JOB_TS}.tar.gz"
CONFIG_YAML="/tmp/vecl-qb-terraform-stockfish-eval-${JOB_TS}.yaml"
