# Legacy VECL-QB root README

This file preserves the earlier reviewer-facing narrative. It predates the committee-readiness
pass and is historical context, not a statement of current guarantees.
